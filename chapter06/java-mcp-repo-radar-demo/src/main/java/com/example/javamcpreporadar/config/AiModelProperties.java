    ...
    public static AiModelProperties fromEnv(Map<String, String> env) {
        return new AiModelProperties(
            ...
            new OpenAiCompatible(
                ...
                readInt(env, "DEEPSEEK_MAX_TOKENS", 900)
            ),
            new Ollama(
            ...
            new OpenAiCompatible(
                ...
                readInt(env, "CHATGPT_MAX_TOKENS", 900)
            )
        );
    }

    public boolean defaultProviderConfigured() {
        return switch (defaultProvider) {
            case DEEPSEEK -> deepseek.configured();
            case CHATGPT -> chatgpt.configured();
            case OLLAMA -> true;
        };
    }
