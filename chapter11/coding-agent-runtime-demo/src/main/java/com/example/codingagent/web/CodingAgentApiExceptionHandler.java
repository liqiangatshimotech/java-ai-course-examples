...
import com.example.codingagent.service.CodingAgentJobNotFoundException;
...
public class CodingAgentApiExceptionHandler {

    @ExceptionHandler(CodingAgentJobNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handleNotFound(CodingAgentJobNotFoundException exception) {
